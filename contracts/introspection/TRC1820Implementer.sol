...
contract TRC1820Implementer is ITRC1820Implementer {
    bytes32 constant private _TRC1820_ACCEPT_MAGIC = keccak256(abi.encodePacked("TRC1820_ACCEPT_MAGIC"));

    mapping(bytes32 => mapping(address => bool)) private _supportedInterfaces;

    /**
     * See {ITRC1820Implementer-canImplementInterfaceForAddress}.
     */
    function canImplementInterfaceForAddress(bytes32 interfaceHash, address account) public view override returns (bytes32) {
        return _supportedInterfaces[interfaceHash][account] ? _TRC1820_ACCEPT_MAGIC : bytes32(0x00);
    }
